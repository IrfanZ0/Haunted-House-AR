...
public class YellowMazeDiamondReader : MonoBehaviour, IBlueDiamondReader, IOrangeDiamondReader, IPurpleDiamondReader, IRedDiamondReader
{
    ...
    private IEnumerator AltarSpeaks ( string diamondName )
    {
        ...
        yield return new WaitForSeconds ( 5f );
        altarTextBox.text = "From here you could be transported to Orange, Purple, Red, and Blue mazes.";
        yield return new WaitForSeconds ( 5f );
