...
public class OrangeMazeDiamondReader : MonoBehaviour, IBlueDiamondReader, IPurpleDiamondReader, IRedDiamondReader, IYellowDiamondReader
{
    ...
    private IEnumerator AltarSpeaks ( string diamondName )
    {
        ...
        yield return new WaitForSeconds ( 5f );
        altarTextBox.text = "From here you could be transported to Blue, Purple, Red, and Yellow mazes.";
        yield return new WaitForSeconds ( 5f );
