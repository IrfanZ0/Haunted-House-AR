...
public class MainMazeDiamondReader : MonoBehaviour, IBlueDiamondReader, IOrangeDiamondReader, IPurpleDiamondReader, IRedDiamondReader, IYellowDiamondReader
{
    ...
    private IEnumerator AltarSpeaks ( string diamondName )
    {
        ...
        yield return new WaitForSeconds ( 5f );
        altarTextBox.text = "From here you could be transported to Blue, Orange, Purple, Red, and Yellow mazes.";
        yield return new WaitForSeconds ( 5f );
