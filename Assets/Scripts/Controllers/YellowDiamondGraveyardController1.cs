...
public class YellowDiamondGraveyardController : MonoBehaviour
{
    ...
    private void Start ( )
    {
        ...
        foreach ( Transform child in yellowDiamondMazeHolder.transform.GetComponentInChildren<Transform> ( ) )
        {
        ...
        player.transform.parent = yellowDiamondMazeHolder.transform;
        startPosition = yellowDiamondMazeHolder.transform.Find ( "Exit Portal" );
