...
public class PurpleDiamondGraveYardController : MonoBehaviour
{
    ...
    private void Start ( )
    {
        ...
        foreach ( Transform child in purpleDiamondMazeHolder.transform.GetComponentInChildren<Transform> ( ) )
        {
        ...
        player.transform.parent = purpleDiamondMazeHolder.transform;
        startPosition = purpleDiamondMazeHolder.transform.Find ( "Exit Portal" );
