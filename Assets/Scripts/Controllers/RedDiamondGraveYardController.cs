...
public class RedDiamondGraveYardController : MonoBehaviour
{
    ...
    private void Start ( )
    {
        ...
        foreach ( Transform child in redDiamondMazeHolder.transform.GetComponentInChildren<Transform> ( ) )
        {
        ...
        player.transform.parent = redDiamondMazeHolder.transform;
        startPosition = redDiamondMazeHolder.transform.Find ( "Exit Portal" );
